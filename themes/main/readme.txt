...
Main is a blank canvas for your ideas and it makes the block editor your best brush.
...
Take it for a spin! See how Main elevates your portfolio, business website, or personal blog.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in Main in the search form and press the 'Enter' key on your keyboard.
...
== Privacy ==
Main uses LocalStorage to save the setting when Dark Mode support is turned on or off.
...
Main WordPress Theme, 2020-2022 WordPress.org
Main is distributed under the terms of the GNU GPL.
...
Main is derived from Seedlet, (C) 2020 Automattic, Inc.

Main is also based on:
